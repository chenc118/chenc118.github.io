...
var _user$project$Main$addFeed = F4(
	function (f, v, x, y) {
		return {
			ctor: '::',
			_0: {
				...
				y: y,
				value: v,
				color: _user$project$Main$genColor(x + y)
			},
			_1: f
		};
	});
var _user$project$Main$consume = F2(
	function (feeds, size) {
		consume:
		while (true) {
			var _p1 = feeds;
...
var _user$project$Main$filterOut = F2(
	function (both, feeds) {
		filterOut:
		while (true) {
			var _p2 = both;
			if (_p2.ctor === '::') {
				if (_p2._0._0 === true) {
					...
					var _v9 = _p2._1,
						_v10 = {ctor: '::', _0: _p2._0._1, _1: feeds};
					both = _v9;
					feeds = _v10;
					continue filterOut;
				}
...
var _user$project$Main$wrap = F2(
	function (a, b) {
		var _p3 = a;
		if (_p3.ctor === '::') {
			var _p4 = b;
			if (_p4.ctor === '::') {
				return {
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: _p3._0, _1: _p4._0},
					_1: A2(_user$project$Main$wrap, _p3._1, _p4._1)
				};
			} else {
				return {ctor: '[]'};
			}
...
var _user$project$Main$drawYLines = F5(
	function (inc, len, ly, total, lines) {
		drawYLines:
		while (true) {
			if (_elm_lang$core$Native_Utils.cmp(ly, total) > 0) {
				return lines;
			} else {
				var _v13 = inc,
					_v14 = len,
					...
					_0: A2(
						_elm_lang$svg$Svg$line,
						{
							...
							_0: _elm_lang$svg$Svg_Attributes$y1(
								_elm_lang$core$Basics$toString(ly)),
							_1: {
								ctor: '::',
								...
								_1: {
									...
									_1: {
										...
										_1: {
											...
											_1: {
												ctor: '::',
												_0: _elm_lang$svg$Svg_Attributes$stroke('lightgrey'),
												_1: {ctor: '[]'}
											}
										}
									}
...
var _user$project$Main$drawXLines = F5(
	function (inc, len, lx, total, lines) {
		drawXLines:
		while (true) {
			if (_elm_lang$core$Native_Utils.cmp(lx, total) > 0) {
				return lines;
			} else {
				var _v18 = inc,
					_v19 = len,
					...
					_0: A2(
						_elm_lang$svg$Svg$line,
						{
							...
							_0: _elm_lang$svg$Svg_Attributes$x1(
								_elm_lang$core$Basics$toString(lx)),
							_1: {
								ctor: '::',
								_0: _elm_lang$svg$Svg_Attributes$x2(
									_elm_lang$core$Basics$toString(lx)),
...
var _user$project$Main$buildFeeds = F2(
	function (feed, mult) {
		var _p5 = feed;
		if (_p5.ctor === '::') {
			var _p6 = _p5._0;
			return {
				...
				_0: A2(
							...
							_1: {
								...
								_0: _elm_lang$svg$Svg_Attributes$r(
									_elm_lang$core$Basics$toString(
										mult * _user$project$Main$mr(_p6.value))),
								_1: {
									ctor: '::',
									_0: _elm_lang$svg$Svg_Attributes$fill(_p6.color),
									_1: {ctor: '[]'}
								}
							}
						}
					...
					{ctor: '[]'}),
				_1: A2(_user$project$Main$buildFeeds, _p5._1, mult)
			};
		} else {
			return {ctor: '[]'};
		}
...
var _user$project$Main$testConsume = function (model) {
	...
	var consumed = A2(
		...
		A3(
			...
			model.y),
		feeds);
	var both = A2(_user$project$Main$wrap, consumed, feeds);
			...
			_1: {
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('Enter the url for the image or choose a color from below'),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
															...
															{ctor: '[]'},
															{
																...
																_0: A2(
																	_elm_lang$html$Html$input,
																	{
																		...
																		_1: {
																			ctor: '::',
																			_0: _elm_lang$html$Html_Attributes$checked(model.minimap),
																			_1: {
																				ctor: '::',
																				_0: _elm_lang$html$Html_Events$onClick(
																					_user$project$Main$Toggle('minimap')),
																				_1: {ctor: '[]'}
																			}
																		}
																	},
																...
																_1: {
																	ctor: '::',
																	_0: _elm_lang$html$Html$text('minimap'),
																	_1: {ctor: '[]'}
																}
															}),
														_1: {ctor: '[]'}
